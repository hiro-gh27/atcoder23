...
public class Main {
  ...
  private void run(String[] arguments) throws Exception {
    ...
    int powerOfFourCount = 0;
    int oddCount = 0;
    int evenCountWithoutPowerOfFour = 0;
    ...
    for (int i = 0; i < N; i++) {
      ...
      if (value % 4 == 0) {
        ...
        evenCountWithoutPowerOfFour++;
      }
    }

    String ans = "No";
    if (powerOfFourCount >= oddCount){
      ans = "Yes";
    }else if (powerOfFourCount == oddCount -1){
      if (evenCountWithoutPowerOfFour == 0){
        ans = "Yes";
      }
    }
    out.println(ans);
