...
public class Main {
  ...
  private void run(String[] arguments) throws Exception {
    ...
    ArrayList<Integer> powerOfTwo = new ArrayList<>();
    powerOfTwo.add(1);
    while (powerOfTwo.get(powerOfTwo.size()-1) < Math.pow(10, 5)){
      int last = powerOfTwo.get(powerOfTwo.size()-1);
      powerOfTwo.add(last*2);
    }
