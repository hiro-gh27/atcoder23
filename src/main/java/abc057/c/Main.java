...
public class Main {
  ...
  private void run(String[] arguments) throws Exception {
    ...
    HashMap<Long, Long> dividers = new HashMap<>();
    ...
    for (Entry<Long, Long> divider : dividers.entrySet()) {
      int maxLength = Math.max(String.valueOf(divider.getKey()).length(), String.valueOf(divider.getValue()).length());
