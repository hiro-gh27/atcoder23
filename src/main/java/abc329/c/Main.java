...
public class Main {
  ...
  private void run(String[] arguments) throws Exception {
    ...
    int MAX_TOTAL_VALUE = (int)(2*Math.pow(10, 5));
    letters = "#".repeat(MAX_TOTAL_VALUE).toCharArray();
    ...
    for (int i = 0; i < letters.length; i++) {
      ...
      double memorySize = sb.toString().getBytes().length / 1000.00;
      totalMemorySize += memorySize;
      LOGGER.info(i + ": " + memorySize + "MB" + "/"+ totalMemorySize + "MB");
    }
